...
def get_jsonData():
    print("#get_jsonData " )
    card_title = "iot sensor value read."
    session_attributes = {}
    sURL=mDnsName +"/api-1"
    ...
    sMsg = "OK, moisture is " +str(result["moisture"])+ " %"
    sMsg+= " , time is " + sHH+" hour "+ sMM+ " minute now."
    speech_output =sMsg
...
def on_intent(intent_request, session):
    ...
    if intent_name == "checkMoistureIntent":
        return get_jsonData()
    else:
